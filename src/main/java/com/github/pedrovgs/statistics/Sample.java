...
public class Sample {
	...
	public static void main(String[] args) {
		...
		for (int i = 1; i < 4; i++) {
			file.add(Integer.toString(i));
		}
		Sample grades = new Sample(file);
		Map<Object,Double> freq = grades.frequencies();
		System.out.println(freq);
		System.out.println(grades.avg());
		System.out.println(grades.median());
		System.out.println(grades.variance());
		System.out.println(grades.standardDeviation());
	 ...
	 * @return The avg.
	 * @throws IllegalArgumentException when the sample is empty or when the Sample is not quantitative.
	 */
	public double avg() {
